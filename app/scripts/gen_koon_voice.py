...
LINES = {
    ...
    "q1_right": "Đúng rồi! Các bạn giỏi quá! Chúng mình đã tìm lại được mảnh màu đỏ đầu tiên rồi!",
    ...
    "q2_right": "Chính xác! Mảnh màu cam đã quay trở lại rồi. Các bạn làm tốt lắm!",
    ...
    "q4_right": "Chính xác! Các bạn giỏi quá! Chỉ còn vài màu nữa thôi!",
    ...
    # --- Phần 3: Recap ---
    "90_recap": "Oa! Chúng mình đã làm được rồi! Nhờ sự thông minh và nhiệt tình của các bạn mà cầu vồng đã tìm lại đủ bảy sắc màu. Vì đã có công giúp cầu vồng lấy lại được bảy màu sắc. Bầu trời đã gửi cho chúng ta một điều kỳ diệu. Các bạn có muốn xem điều kỳ diệu ấy là gì không?",
    # --- Phần 4: Tạm biệt ---
